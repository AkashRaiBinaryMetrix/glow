    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-0">
         <div class="login-wrapper">
			...
			<form class="login-form" id="eventForm" enctype="multipart/form-data" name="cform" method="post">
                  ...
                  <div class="form-group">
				  <p class="contact-form-name">
					<input type="datetime-local" name="" id="" class="form-control" placeholder="Start Date">
				  </p>
				  </div>
                ...
                <div class="form-group">
				  <p class="contact-form-name">
					<input type="text" name="" id="" class="form-control" placeholder="Location" required="">
				  </p>
				  </div>
                ...
                <div class="form-group">
				  <textarea class="form-control" id="address" placeholder="Description (Optional)" rows="2"></textarea>
				</div>
