...
@section('title', 'Discover Groups List')
@section('content')
            ...
            <div class="row">
	          @if (!empty($aGroupLists))
               ...
               @php
                      ...
                      /*-------------------- check is user joined this group or not ----------------------------------*/
                        $isGroupJoined = isGroupJoinedByUser($aGroup->id);
                        if($isGroupJoined > 0) {
                             continue;
                        }
                      /*-------------------- check is user joined this group or not ----------------------------------*/
                 @endphp
                  <div class="col-md-4" id="individualGroup{{$aGroup->id}}">
