        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
                 ...
                 <div class="col-md-3">
                    <a href="{{ url('admin/add-cms-page') }}" class="btn btn-primary">Add CMS Page</a>
                 </div>
                 <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                 <a href="{{url('admin/cms-page-list')}}" class="btn btn-primary">Clear Filter</a>
              </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                   @include('admin.cms.list')
                </tbody>
              </table>
              <input type="hidden" id="route" name="route" value="admin/fetchCMSPageData">
