        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                 <a href="{{url('admin/banners-list')}}" class="btn btn-primary">Clear Filter</a>
              </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                   @include('admin.banners.list')
                </tbody>
                <input type="hidden" id="route" name="route" value="admin/fetchBannersData">
