<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item" id="leftEvents">
      <a class="nav-link" href="{{ url('admin/events-list') }}">
        <i class="icon-head menu-icon"></i>
        <span class="menu-title">Events</span>
      </a>
    </li>
    <li class="nav-item" id="leftCMS">
      <a class="nav-link" href="{{ url('admin/cms-page-list') }}">
        <i class="icon-head menu-icon"></i>
        <span class="menu-title">CMS Page</span>
      </a>
    </li>
    <li class="nav-item" id="leftBanners">
      <a class="nav-link" href="{{ url('admin/banners-list') }}">
        <i class="icon-head menu-icon"></i>
