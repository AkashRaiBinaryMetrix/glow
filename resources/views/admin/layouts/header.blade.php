  ...
  <header class="main-header">
    <div class="container">
      ...
      <div class="topbar">
        ...
        <a href="register.html">Create Account</a> <span>/</span> <a href="login.html">Sign In</a>
      </div>
      ...
      <nav class="navbar navbar-expand-lg p-0 align-items-center">
        ...
        <a class="navbar-brand" href="index.html">
          <div class="logo">
            ...
            //]]>
            </script><img src="images/logo.png" alt="" data-pagespeed-url-hash="1514387616"
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="inspirational-feed.html">Inspirational Feed</a></li>
          ...
          <div class="menu-ham-ico"><i class="las la-bars"></i></div>
