        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
                 ...
                 <div class="col-md-2">
                    <a href="{{ url('admin/add-group') }}" class="btn btn-primary">Add Group</a>
                 </div>
                 <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                 <a href="{{url('admin/groups-list')}}" class="btn btn-primary">Clear Filter</a>
              </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <input type="hidden" id="route" name="route" value="admin/fetchGroupsData">
